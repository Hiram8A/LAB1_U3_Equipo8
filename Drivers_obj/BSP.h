...
#define BSP_BUTTON6 ((PORT_2 | GPIO_PIN_VALID | GPIO_PIN_IRQ | GPIO_IRQ_EDGE_H_TO_L) | GPIO_PIN6)
#define BSP_BUTTON7 ((PORT_2 | GPIO_PIN_VALID | GPIO_PIN_IRQ | GPIO_IRQ_EDGE_H_TO_L) | GPIO_PIN7)
